  ...
  return (
    <section style={{ background: '#fff', borderTop: '1px solid var(--line)', borderBottom: '1px solid var(--line)' }}>
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '32px 32px' }}>
        <div style={{ fontSize: 12, color: 'var(--muted)', textAlign: 'center', textTransform: 'uppercase', letterSpacing: '0.08em', fontFamily: 'Geist Mono, monospace', marginBottom: 24, display: 'inline-flex', alignItems: 'center', gap: 12, justifyContent: 'center', width: '100%' }}>
          <span style={{ width: 32, height: 1, background: 'var(--line)' }} />
          Wir verbinden Ihre bestehenden Systeme
          <span style={{ width: 32, height: 1, background: 'var(--line)' }} />
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(8, 1fr)', gap: 16, alignItems: 'center', justifyItems: 'center' }}>
